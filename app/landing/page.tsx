    ...
    <div className="min-h-screen bg-amber-50 font-sans">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white shadow-sm py-4' : 'bg-amber-50 py-6'}`}>
        <div className="max-w-6xl mx-auto px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => router.push('/login')} className="px-5 py-2.5 bg-stone-800 text-white text-sm font-semibold rounded-lg hover:bg-stone-900 transition shadow-sm">
              Get Started Free
            </button>
          </div>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-2 bg-white text-stone-600 text-sm font-medium px-4 py-2 rounded-full mb-8 shadow-sm border border-stone-200">
              ...
              Simple phones that bring people together
            </div>
            <h1 className="text-5xl md:text-6xl font-extrabold text-stone-900 mb-6 leading-tight tracking-tight">
              Stay connected.<br />
              <span className="text-amber-600">The simple way.</span>
            </h1>
            <p className="text-xl text-stone-500 mb-10 leading-relaxed">
              Whether it's keeping your kids phone-safe, staying close with grandparents across the country, or keeping family ties strong across borders — Ring Ring Club makes calling simple, safe, and personal again.
            </p>
          ...
          <div className="relative flex flex-col gap-4">
            ...
            <div className="absolute -top-4 -right-4 bg-white rounded-2xl shadow-xl p-4 border border-stone-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-stone-800">Approved contacts only</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-12 bg-white border-y border-stone-100">
        <div className="max-w-6xl mx-auto px-8 text-center">
          <p className="text-stone-400 text-sm font-medium uppercase tracking-widest mb-6">Trusted by families across America and beyond</p>
          <div className="flex flex-wrap items-center justify-center gap-12 text-stone-300 font-bold text-lg">
            {['The Johnsons', 'Smith Family', 'The Garcias', 'The Williams', 'The Nguyens'].map((name) => (
      ...
      <section className="py-28 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-amber-600 font-semibold text-sm uppercase tracking-widest">Who It's For</span>
      ...
      <section id="features" className="py-28 px-8 bg-amber-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-stone-900 mt-2 mb-4">Built for real people, not tech experts</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              { icon: '⚡', title: 'Quick Dial', description: 'Press 1 for Mom, Press 2 for Grandma. Assign speed dial slots so calling is always just one button away.', color: 'bg-sky-100 text-sky-700' },
              ...
              { icon: '🌍', title: 'International Calling', description: 'Keep family ties strong no matter where they live. Call loved ones abroad as easily as calling next door.', color: 'bg-purple-100 text-purple-600' },
      ...
      <section id="how" className="py-28 px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: '01', title: 'Plug in your phone', description: 'Connect any analog home phone to our pre-configured adapter. It arrives ready to go — no setup needed on your end.', icon: '🔌' },
              { step: '02', title: 'Add approved contacts', description: 'Log in to your Ring Ring Club dashboard and add the friends and family members you want to allow. Just a name and number.', icon: '👨‍👩‍👧' },
              { step: '03', title: 'Let them ring!', description: "Your phone is live. Approved friends and family can call freely. Everyone else is automatically blocked. You stay in control.", icon: '🔔' },
            ].map((item, i) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            {[
              ...
              >
                ...
                <div className="text-sm font-semibold mb-1 text-stone-400">{plan.name}</div>
                <div className="flex items-end gap-1 mb-1">
                  <span className={`text-5xl font-extrabold ${plan.highlight ? 'text-white' : 'text-stone-900'}`}>{plan.price}</span>
                  <span className="text-sm mb-2 text-stone-400">/{plan.period}</span>
                </div>
      ...
      <section className="py-28 px-8 bg-amber-50 relative overflow-hidden border-t border-amber-100">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-stone-900 mb-4">
            Bring your people closer.<br />The simple way.
          </h2>
          <p className="text-stone-500 text-lg mb-10 max-w-xl mx-auto">
            Whether they're down the street or across the world — Ring Ring Club keeps the people you love just one ring away.
          </p>
          <button
            onClick={() => router.push('/login')}
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-start justify-between gap-8 mb-12">
            <div>
              ...
              <p className="text-sm text-stone-400 max-w-xs">Simple phones that bring families and friends together — wherever they are in the world.</p>
            </div>
