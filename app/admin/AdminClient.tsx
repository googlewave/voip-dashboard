...
import { formatPhoneDisplay, formatPhoneInput, normalizePhoneToE164 } from '@/lib/phone';
              ...
              <div className="p-4 flex justify-between items-center">
                <div>
                  ...
                  <div className="text-xs text-slate-500 mt-0.5">
                    ID: {u.id}
                    {u.twilioNumber && (
                      <span className="ml-3 text-green-400 font-mono">📞 {formatPhoneDisplay(u.twilioNumber)}</span>
                    )}
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    {u.twilioNumber ? (
                      <div className="flex items-center gap-3 p-3 bg-green-900/30 border border-green-700 rounded-lg">
                        <span className="text-green-300 font-mono text-sm">{formatPhoneDisplay(u.twilioNumber)}</span>
                                      ...
                                      >
                                        ...
                                        {contact ? (
                                          <>
                                            ...
                                            <p className="text-xs text-slate-400 font-mono truncate">{formatPhoneDisplay(contact.phoneNumber)}</p>
                                            <button
                                      ...
                                      {deviceContacts.map((c) => (
                                        <div key={c.id} className="flex items-center justify-between bg-slate-700/50 rounded-lg px-3 py-2">
                                          <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs text-slate-400 font-mono">{formatPhoneDisplay(c.phoneNumber)}</span>
                                          </div>
                                          <div className="flex items-center gap-2">
                                            <select
